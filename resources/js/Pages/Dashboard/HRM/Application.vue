...
const toastType = ref("success"); // 1. Add this ref here

const triggerToast = (msg, type = "success") => { // 2. Add the 'type' parameter
    toastMessage.value = msg;
    toastType.value = type; // 3. Set the type so the template knows to turn red
