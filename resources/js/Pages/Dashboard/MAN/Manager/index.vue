...
<template>
    <AuthenticatedLayout>
        ...
        <div
            class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-zinc-900 dark:via-zinc-900 dark:to-zinc-800">
            <div class="p-4 sm:p-6 max-w-7xl mx-auto space-y-6 sm:space-y-8">
                <!-- Header -->
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1
                            class="text-2xl sm:text-3xl font-black bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-black">
                            Manufacturing Management <span class="text-blue-600">Dashboard</span>
                        </h1>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ getGreeting() }}, oversee production
                            and staff</p>
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    <div
                        class="group relative overflow-hidden bg-white dark:bg-zinc-900/80 backdrop-blur-sm p-5 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-zinc-800 hover:scale-[1.02]">
                        <div
                        ...
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mt-1">{{
                                    stats.receivedOrders }}</p>
                                <p class="text-xs text-green-600 dark:text-green-400 mt-1 flex items-center gap-1">
                                    <TrendingUp class="w-3 h-3" /> +12%
                                </p>
                            </div>
                            <div
                                class="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-2xl group-hover:rotate-6 transition-transform">
                    ...
                    <div
                        ...
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mt-1">{{
                                    stats.inProduction }}</p>
                                <p class="text-xs text-yellow-600 dark:text-yellow-400 mt-1">Active orders</p>
                            </div>
                            <div
                                class="p-3 bg-yellow-100 dark:bg-yellow-900/30 rounded-2xl group-hover:rotate-6 transition-transform">
                                <Factory class="w-5 h-5 text-yellow-600 dark:text-yellow-400" />
                            </div>
                        </div>
                    </div>
                    <div
                        class="group relative overflow-hidden bg-white dark:bg-zinc-900/80 backdrop-blur-sm p-5 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-zinc-800 hover:scale-[1.02] sm:col-span-2 lg:col-span-1">
                        <div
                        ...
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mt-1">{{
                                    stats.activeMachines }}</p>
                                <p class="text-xs text-green-600 dark:text-green-400 mt-1 flex items-center gap-1">
                                    <CheckCircle2 class="w-3 h-3" /> Operational
                                </p>
                            </div>
                            <div
                                class="p-3 bg-green-100 dark:bg-green-900/30 rounded-2xl group-hover:rotate-6 transition-transform">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div
                        ...
                        <div class="h-48 flex items-end gap-2">
                            <div v-for="(value, idx) in productionTrend.values" :key="idx"
                                ...
                                <span class="text-[10px] sm:text-xs mt-2 text-gray-500">{{ productionTrend.months[idx]
                                    }}</span>
                    ...
                    <div
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-1 h-6 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                                    <div class="h-full bg-green-500 rounded-full transition-all duration-700"
                                        :style="{ width: `${(machineUtilization.available / totalMachines) * 100}%` }">
                                    </div>
                                </div>
                            ...
                            <div class="flex items-center gap-3">
                                <span
                                    class="w-20 text-sm font-medium text-gray-600 dark:text-gray-400">Maintenance</span>
                                <div class="flex-1 h-6 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                                    <div class="h-full bg-yellow-500 rounded-full transition-all duration-700"
                                        :style="{ width: `${(machineUtilization.maintenance / totalMachines) * 100}%` }">
                                    </div>
                                </div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-1 h-6 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                                    <div class="h-full bg-red-500 rounded-full transition-all duration-700"
                                        :style="{ width: `${(machineUtilization.retired / totalMachines) * 100}%` }">
                                    </div>
                                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div
                        class="lg:col-span-1 bg-white dark:bg-zinc-900 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-zinc-800">
                        <div class="flex items-center gap-2 mb-4">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start gap-3">
                                <div class="p-1.5 bg-blue-50 rounded-lg">
                                    <Factory class="w-3 h-3 text-blue-600" />
                                </div>
                                <div>
                                    <p class="text-sm text-gray-700 dark:text-gray-300">Order #PO-2026-045 sent to
                                        production</p>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <p class="text-sm text-gray-700 dark:text-gray-300">Staff role updated: John →
                                        Dyeing Color</p>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <p class="text-sm text-gray-700 dark:text-gray-300">Low yarn stock alert for
                                        Polyester</p>
                    ...
                    <!-- Staff Management Section (full width on lg) -->
                    <div
                        class="lg:col-span-2 bg-white dark:bg-zinc-900/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 dark:border-zinc-800 overflow-hidden">
                        <div
                            class="px-4 md:px-6 py-4 border-b border-gray-100 dark:border-zinc-800 bg-gradient-to-r from-gray-50 to-white dark:from-zinc-800/50 dark:to-zinc-900/50">
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                <div class="flex items-center gap-2">
                                    <div class="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-xl">
                                        <Users class="w-5 h-5 text-blue-600 dark:text-blue-400" />
                                    </div>
                                    <h2 class="text-lg md:text-xl font-bold text-gray-900 dark:text-white">Manufacturing
                                        Staff</h2>
                                    <span
                                        class="px-2 py-1 text-xs font-medium bg-gray-100 dark:bg-zinc-800 text-gray-600 dark:text-gray-400 rounded-full">
                                ...
                                <div class="relative w-full sm:w-64">
                                    ...
                                    <input v-model="searchQuery" type="text" placeholder="Search by name or role..."
                                        class="w-full pl-9 pr-8 py-2 text-sm border border-gray-200 dark:border-zinc-700 rounded-xl bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" />
                        ...
                        <div class="block md:hidden divide-y divide-gray-100 dark:divide-zinc-800">
                            <div v-for="user in filteredStaff" :key="user.id"
                                class="p-4 hover:bg-gray-50 dark:hover:bg-zinc-800/50 transition-all">
                                <div class="flex items-start gap-3">
                                    <div class="flex-shrink-0">
                                        <div
                                            :class="['w-10 h-10 bg-gradient-to-br rounded-xl flex items-center justify-center text-white font-bold text-sm', getAvatarColor(user.name)]">
                                            {{ user.name.charAt(0).toUpperCase() }}
                                        </div>
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <h3 class="text-sm font-semibold text-gray-900 dark:text-white">{{ user.name }}
                                        </h3>
                                        <p
                                            class="text-xs text-gray-500 dark:text-gray-400 mt-0.5 capitalize flex items-center gap-1">
                                            <component :is="getRoleIcon(user.manufacturing_role)" class="w-3 h-3" />
                                            {{ formatRole(user.manufacturing_role) }}
                                        </p>
                                        <div class="mt-3">
                                            <select v-model="user.newRole"
                                                @change="onRoleChange(user.id, user.newRole, user.manufacturing_role, user.name)"
                                                class="w-full border border-gray-200 dark:border-zinc-700 rounded-lg p-2 text-sm bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500">
                                                <option v-for="option in roleOptions" :key="option.value"
                            ...
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-zinc-800">
                                    <tr v-for="user in filteredStaff" :key="user.id"
                                        class="hover:bg-gray-50 dark:hover:bg-zinc-800/30 transition-all">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-3">
                                                <div
                                                    :class="['w-8 h-8 bg-gradient-to-br rounded-lg flex items-center justify-center text-white font-bold text-xs', getAvatarColor(user.name)]">
                                                    {{ user.name.charAt(0).toUpperCase() }}
                                                </div>
                                                <span class="font-medium text-gray-900 dark:text-white">{{ user.name
                                                    }}</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-1">
                                                <component :is="getRoleIcon(user.manufacturing_role)"
                                                    class="w-4 h-4 text-gray-500 dark:text-gray-400" />
                                                <span
                                                    class="px-2 py-1 text-xs font-medium rounded-full bg-gray-100 dark:bg-zinc-800 text-gray-700 dark:text-gray-300 capitalize">
                                                    {{ formatRole(user.manufacturing_role) }}
                                                </span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <select v-model="user.newRole"
                                                @change="onRoleChange(user.id, user.newRole, user.manufacturing_role, user.name)"
                                                class="border border-gray-200 dark:border-zinc-700 rounded-lg px-3 py-1.5 text-sm bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 w-48">
                                                <option v-for="option in roleOptions" :key="option.value"
                                                    :value="option.value">{{ option.label }}</option>
                                            </select>
                                        </td>
                        ...
                        <div v-if="filteredStaff.length === 0" class="text-center py-12">
                            ...
                            <button @click="clearSearch"
                                class="mt-2 text-sm text-blue-600 dark:text-blue-400 hover:underline">Clear
                                search</button>
                        </div>
                    </div>
                </div>
        ...
        <div v-if="showConfirmModal"
            ...
            <div
                class="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl max-w-md w-full transform transition-all border border-gray-200 dark:border-zinc-700 overflow-hidden">
                <div class="p-6">
                    <div class="flex items-center gap-3 mb-4">
                        <div
                            class="w-12 h-12 bg-amber-100 dark:bg-amber-900/30 rounded-full flex items-center justify-center">
                            <UserCheck class="w-6 h-6 text-amber-600 dark:text-amber-400" />
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white">Confirm Role Change</h3>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-6">
                        Are you sure you want to change the role of <span class="font-semibold">{{ pendingStaffName
                            }}</span> from
                        <span class="font-semibold text-gray-900 dark:text-white">{{ formatRole(pendingOldRole)
                            }}</span> to
                        <span class="font-semibold text-blue-600 dark:text-blue-400">{{ formatRole(pendingNewRole)
                            }}</span>?
                    </p>
                    <div class="flex justify-end gap-3">
                        <button @click="closeModal" :disabled="isUpdating"
                            class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-zinc-800 rounded-lg hover:bg-gray-200 dark:hover:bg-zinc-700 transition disabled:opacity-50">
                            Cancel
                        </button>
                        <button @click="confirmUpdate" :disabled="isUpdating"
                            class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition flex items-center gap-2 disabled:opacity-50">
        ...
        <!-- Toast Notification -->
        <div v-if="showToast" class="fixed bottom-4 right-4 z-50 transform transition-all duration-300"
            :class="{ 'bg-green-100 dark:bg-green-900/80 border-green-400': toastType === 'success', 'bg-red-100 dark:bg-red-900/80 border-red-400': toastType === 'error' }"
            style="animation: slide-up 0.3s ease-out;">
            <div class="flex items-center gap-3 px-4 py-3 rounded-lg shadow-lg border">
                <component :is="toastType === 'success' ? CheckCircle2 : AlertCircle" class="w-5 h-5"
